 ...
 * Для первого дня значения температур составляют: -5°, 7°, 1°; для второго дня: 3°, 2°, 3°; и для третьего дня: -1°,
 * -1°, 10° . Массив, отражающий такую статистику, будет выглядеть так:
 * $data = [
 * [-5, 7, 1],
 * [3, 2, 3],
 * [-1, -1, 10],]
...
function getIndexOfWarmestDay($data)
{
    ...
    $maxesArray = array_map('maxed', $data);
    return array_keys($maxesArray, max($maxesArray));
}
...
var_dump(getIndexOfWarmestDay($datanull));